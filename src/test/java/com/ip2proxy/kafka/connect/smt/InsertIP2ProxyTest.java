...
public class InsertIP2ProxyTest {
    ...
    private static String countryField = "ip2proxy_country_code";
    private static String expectedCountry = "-"; // LITE PX BIN files only carry PUB proxies

    private InsertIP2Proxy<SourceRecord> xform;
    ...
    @BeforeEach
    void init() {
        xform = new InsertIP2Proxy.Value<>();
    }
    ...
    public void topLevelStructRequired() {
        assertThrows(DataException.class, () -> {
            ...
            settings.put("ip2proxy.bin.path", binFilePath);
            settings.put("ip2proxy.input", inputField);
    ...
    @Test
    public void copySchemaAndInsertIP2ProxyField() {
        final Map<String, Object> props = new HashMap<>();

        props.put("ip2proxy.bin.path", binFilePath);
        props.put("ip2proxy.input", inputField);
    ...
    @Test
    public void schemalessInsertIP2ProxyField() {
        final Map<String, Object> props = new HashMap<>();
